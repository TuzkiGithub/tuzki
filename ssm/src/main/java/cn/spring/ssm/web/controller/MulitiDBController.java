...
import cn.spring.ssm.web.dao.master.StudentMapper_master;
import cn.spring.ssm.web.dao.slave.StudentMapper_slave;
...
public class MulitiDBController {
    ...
    public String atomikosTransactionBefore(@PathVariable("id1") Integer id1, @PathVariable("id2") Integer id2) throws JsonProcessingException {
    ...
    @Transactional
    public String atomikosTransactionAfter(@PathVariable("id1") Integer id1, @PathVariable("id2") Integer id2) throws JsonProcessingException {
        Student student1 = new Student();
